...
public class Activity_Goods_Compelted extends AppCompatActivity
{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        continue_booklater.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Constants.goodscompleted_moving = "Goods_congratulations";
                Intent i = new Intent(Activity_Goods_Compelted.this, MainActivity.class);
    ...
    public void init()
    {
        ...
        sm=new SessionManager(Activity_Goods_Compelted.this);
        UF=new UserFunctions(Activity_Goods_Compelted.this);
        cd= new ConnectionDetector(Activity_Goods_Compelted.this);
    ...
    private class GetJsonmovemyhome_save extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            loading = new ProgressDialog(Activity_Goods_Compelted.this);
