...
import com.trukker.trukkershipperuae.activity.Activity_Goods_payment;
 ...
 */
public class Fragment_Myorder_Goods_draft extends Fragment implements SwipeRefreshLayout.OnRefreshListener
{
    //class object
    UserFunctions UF;
    SessionManager sm;
    ...
    public Fragment_Myorder_Goods_draft()
    {
                             ...
                             Bundle savedInstanceState)
    {
        ...
        order_listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent i = new Intent(getActivity().getApplicationContext(), Activity_Goods_payment.class);
    ...
    public void init()
    {
        ...
        sm = new SessionManager(Fragment_Myorder_Goods_draft.this.getActivity());
        UF = new UserFunctions(Fragment_Myorder_Goods_draft.this.getActivity());
        cd = new ConnectionDetector(Fragment_Myorder_Goods_draft.this.getActivity());
...
//                            order_listview.setAdapter(adapter);
    ...
    {
        // its for tab
        Fragment_Myorder_Goods_draft mFragment = new Fragment_Myorder_Goods_draft();
    ...
    public class OrderGoods_Adapter extends ArrayAdapter<Order_method>
    {
        ...
        {
            super(context,  R.layout.list_order_movinggoods, objects);
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (convertView  == null)
            {
                ...
                rowView = vi.inflate(R.layout.list_order_movinggoods, null);
            ...
            vh.reshedule_layout.setVisibility(View.GONE);
            if(status.equalsIgnoreCase("02"))
            {
                ...
                vh.sheduletitle_txt.setText("Scheduled ");
        ...
        class ViewHolder {
            ...
            TextView cancleorder_layout,sheduletitle_txt,load_inquiry_no,inquiry_destination_addr,inquiry_source_addr,SizeTypeDesc,load_inquiry_shipping_date,load_inquiry_shipping_date1,driver_name;
        ...
        private void setViewHolder(View rowView)
        {
            ...
            vh.inquiry_destination_addr = (TextView) rowView.findViewById(R.id.movingto_txt);
            vh.inquiry_source_addr = (TextView) rowView.findViewById(R.id.movingfrom_txt);
            vh.SizeTypeDesc = (TextView) rowView.findViewById(R.id.type_txt);

            vh.load_inquiry_shipping_date = (TextView) rowView.findViewById(R.id.shedule_txt);
            ...
            vh.sheduletitle_txt= (TextView) rowView.findViewById(R.id.sheduletitle_txt);
            ...
            vh.reshedule_layout=(LinearLayout)rowView.findViewById(R.id.reschule_layout);
            rowView.setTag(vh);
...
//                        actorsList = new ArrayList<Order_method>();
                        ...
                        if (status.equalsIgnoreCase("1"))
                        {
                            ...
                            for(int i=0;i<array.length();i++)
                            {
                                ...
                                else if(array.getJSONObject(i).getString("order_type_flag").toString().equalsIgnoreCase("HT"))
                                {
