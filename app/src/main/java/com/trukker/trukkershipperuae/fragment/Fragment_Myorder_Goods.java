 ...
 */
public class Fragment_Myorder_Goods extends Fragment implements SwipeRefreshLayout.OnRefreshListener
{
    //class object
    UserFunctions UF;
    SessionManager sm;
   ...
   GetJson_save getJson_save;
                             ...
                             Bundle savedInstanceState)
    {
        ...
        //swipe functinality
        swipeRefreshLayout.setOnRefreshListener(Fragment_Myorder_Goods.this);
    ...
    public void init()
    {
        ...
        sm = new SessionManager(Fragment_Myorder_Goods.this.getActivity());
        UF = new UserFunctions(Fragment_Myorder_Goods.this.getActivity());
        cd = new ConnectionDetector(Fragment_Myorder_Goods.this.getActivity());
...
//                            order_listview.setAdapter(adapter);
    ...
    {
        // its for tab
        Fragment_Myorder_Goods mFragment = new Fragment_Myorder_Goods();
    ...
    public class OrderGoods_Adapter extends ArrayAdapter<Order_method>
    {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            else if(status.equalsIgnoreCase("25"))
            {
                ...
                vh.sheduletitle_txt.setText("Scheduled on");
            ...
            else if(status.equalsIgnoreCase("45"))
            {
                ...
                vh.sheduletitle_txt.setText("Completed on");
            }
