...
public class Movinggoods_Webview extends AppCompatActivity
{
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event)
    {
        if (keyCode == KeyEvent.KEYCODE_BACK)
        {
            ...
            Intent i = new Intent(Movinggoods_Webview.this, MainActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        sm=new SessionManager(Movinggoods_Webview.this);
        UF=new UserFunctions(Movinggoods_Webview.this);
        cd= new ConnectionDetector(Movinggoods_Webview.this);
        ...
        try
        {
            ...
            webView.loadUrl(UserFunctions.trip_web);
    ...
    public class WebViewClient extends android.webkit.WebViewClient
    {
        ...
        public void onPageStarted(WebView view, String url, Bitmap favicon) {
            ...
            loading = new ProgressDialog(Movinggoods_Webview.this);
