...
public class Movinghome_Webview extends AppCompatActivity
{
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event)
    {
        if (keyCode == KeyEvent.KEYCODE_BACK)
        {
            ...
            Intent i = new Intent(Movinghome_Webview.this, MainActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        sm=new SessionManager(Movinghome_Webview.this);
        UF=new UserFunctions(Movinghome_Webview.this);
        cd= new ConnectionDetector(Movinghome_Webview.this);
        ...
        try
        {
            ...
            webView.loadUrl(UserFunctions.home_web);
    ...
    public class WebViewClient extends android.webkit.WebViewClient
    {
        ...
        public void onPageStarted(WebView view, String url, Bitmap favicon) {
            ...
            loading = new ProgressDialog(Movinghome_Webview.this);
